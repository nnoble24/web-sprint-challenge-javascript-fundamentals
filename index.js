...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The internal variable is located in the brackets of the myFunction function, therefor giving nestedFunction acess to internal. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    let lowerArr = zooAnimals.map(animal => {
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let popArry = zooAnimals.filter(animal => animal.population < 5);
    return popArry;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    let sumWithInitial = zooAnimals.reduce((pre, curr) => pre + curr.population, 0);
...
function CuboidMaker(volumeO){
  this.length = volumeO.length;
  this.width = volumeO.width;
  this.height = volumeO.height;
